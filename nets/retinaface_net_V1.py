...
class RetinaFace(nn.Module):
    def __init__(self, cfg = None, phase = 'train'):
        ...
        if cfg['name'] == 'mobilenet0.25':
            ...
            if cfg['pretrain']:
                checkpoint = torch.load("./weights/mobilenetV1X0.25_pretrain.tar", map_location=device)
                from collections import OrderedDict
        ...
        in_channels_list = [         # 主干网络中三个不同大小的特征层：64 、128 、256，链接检测分支
...
class MobileNetV1(nn.Module):
    def __init__(self):
        ...
        self.stage2 = nn.Sequential(
            conv_dw(64, 64, 2),  # 43 + 16 = 59
            conv_dw(64, 64, 1), # 59 + 32 = 91
        ...
        self.stage3 = nn.Sequential(
            conv_dw(64, 64, 2), # 219 +3 2 = 241
            conv_dw(64, 64, 1), # 241 + 64 = 301
        )
